...
const index = () => {
  return Array.from({ length: 3 }).map((_, i) => {
    return (
      <div key={i} className="flex flex-col w-full bg-gray-950 rounded-3xl p-4 text-gray-200 my-3">
        <div className="flex">
        ...
        <div className="ml-[48px] mt-3">
          <Skeleton className=" ml-5 w-[120px] md:w-[310px] lg:w-[670px] h-4 rounded-xl my-1" />
        </div>
